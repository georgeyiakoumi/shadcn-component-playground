...
export function ExportDialog({
  ...
  // GEO-305 Step 6: the export dialog now downloads the page-supplied
  // `source` prop directly. Source is generated by the page via
  // generateFromTreeV2, so this dialog doesn't need to re-derive it.
